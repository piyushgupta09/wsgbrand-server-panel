...
<div class="ms-auto d-flex">
    <div class="dropdown">
        <button class="btn text-muted border dropdown-toggle" type="button" data-bs-toggle="dropdown"
            aria-expanded="false">
                    ...
                    <li>
                        <div class="dropdown-item d-flex align-items-center">
                            <input class="form-check-input" type="checkbox"
                                id="input{{ $modelName }}{{ $field['name'] }}"
                                wire:model="fields.{{ $field['name'] }}.viewable.{{ $activePage }}">
                            <label class="form-check-label px-1 flex-fill"
